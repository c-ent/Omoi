...
const Slider = () => {
  return (
    <div className="md:mt-[-50px] flex flex-col md:flex-row mx-auto gap-5 items-center justify-center  overflow-hidden -z-50">
      <div className="w-full max-w-[350px] min-h-[250px] flex flex-col items-start bg-[#66FF88] shadow-md transform transition-transform duration-500 rounded-lg p-8 mb-4 md:mb-[200px]">
      ...
      <div className="w-full max-w-[350px] min-h-[250px] flex flex-col items-start bg-[#FF7676] shadow-md transform transition-transform duration-500 rounded-lg p-8 mb-4 md:mb-0">
      ...
      <div className="w-full max-w-[350px] min-h-[250px] flex flex-col items-start bg-[#FFEA4F] shadow-md transform transition-transform duration-500 rounded-lg p-8 mb-4 md:mb-[200px]">
